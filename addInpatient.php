...
<body>
    <h2 style="text-align:center; margin-top:20px;">Add new patient infor: CLASS INPATIENT</h2>
    <form action="addInpatient.php" style="margin-left: 40%;font-size:18px;font-weight:bold;" method="post">
