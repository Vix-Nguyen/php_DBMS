...
<meta charset="UTF-8">
    ...
    <form action="main.php" method="post" style="float:right;margin-top:10px;margin-right:10px">
...
<body>
    ...
    <form action="main.php" method="post" style="margin-left:10px;font-size:16px;font-weight:bold;">
